...
Este proyecto analiza información de precios, calificaciones y tendencias en el mercado de videojuegos. El objetivo es explorar cómo variables como la **violencia**, el **género**, la **plataforma** y la **inflación** se relacionan con el **precio final de los videojuegos**.
...
1. **Distribución de precios (histograma mejorado)**  
   Muestra cómo se distribuyen los precios en 2026 y permite identificar si el mercado presenta sesgos hacia precios bajos o altos.

2. **Boxplot de violencia vs precio**  
   Analiza cómo el nivel de violencia afecta el precio promedio de los videojuegos.

3. **Gráfica de correlación (heatmap)**  
   Muestra la relación entre variables numéricas como inflación, precio actual, precio ajustado, etc.

4. **Dispersión inflación vs precio actual**  
   Analiza si existe una relación significativa entre la inflación y los precios finales.
...
Para generar las visualizaciones, ejecuta el archivo principal desde la terminal:
